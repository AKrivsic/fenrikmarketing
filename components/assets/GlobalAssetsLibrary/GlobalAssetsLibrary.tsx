...
import styles from "@/components/assets/ProjectAssetsLibrary/ProjectAssetsLibrary.module.css";

type SortOrder = "newest" | "oldest";

const ASSET_CLASS_OPTIONS: AssetClass[] = ["static", "editable", "reference"];

interface GlobalAssetsLibraryProps {
  assets: AssetView[];
}

export function GlobalAssetsLibrary({ assets }: GlobalAssetsLibraryProps) {
  ...
  return (
    <div className={styles.wrap}>
      ...
      <AssetGrid assets={filtered} onPreview={setPreviewAsset} />

...
export function buildPresentationGenerationBlock(args: {
  ...
  if (allowsCta) {
    lines.push(
      ...
      "",
      "Valid closing approaches (choose ONE that fits the beat — not always a CTA card):",
      "- narrative conclusion (IMAGE still)",
      "- question or insight/payoff still",
      "- product visual / logo brand close",
      "- soft text-led close without a button",
      "- typed CTA scene when appropriate",
      "",
      "CTA rules:",

...
export function renderVisualBeatsSection(
  ...
  return [
    "",
    `VISUAL BEATS: provide 4–${MAX_VIDEO_SCENE_STILLS} image_prompts. Each one is a`,
    "GENERATED still image — standard packages need 4–5 AI stills for visual richness.",
    "A high-quality library asset may accompany AI as an enhancement (prefer 4 AI + 1 asset)",
    "or replace one of five AI stills (5 AI → 4 AI + 1 asset). Assets are never mandatory.",
    "Do NOT drop to 3 AI stills just because an asset exists. Do NOT provide more than",
    ...
    "Controlled exception: unfinished whiteboard / marker mid-stroke gestures may",
    "be described as illegible partial letterforms (never quote specific words).",
...
export function renderAssetsSection(
  ...
  return [
    ...
    "- Standard shorts (≈20–40s): plan 4–5 AI image scenes for visual richness.",
    "- Assets are OPTIONAL enhancements — never mandatory. AI-only packages are preferred defaults.",
    "- A high-quality product screenshot / UI / real photography / brand asset may REPLACE",
      "  exactly ONE AI scene when it clearly improves credibility AND the package still",
      "  keeps 4–5 AI stills overall (prefer 4 AI + 1 asset or 5 AI; do not ship 3 AI).",
      "  Within the 5-still cap, prefer adding the asset as an enhancement (4 AI + 1 asset)",
      "  rather than dropping an AI beat.",
    "- If no suitable high-quality asset exists, generate AI instead — do not force asset usage.",
    "- Do NOT plan 3 AI + 1 asset simply because an asset is listed; that reduces richness.",
    ...
    "- Prefer product_ui / dashboard / real photography / brand material with quality=high.",
    "- Reject low-quality, decorative, duplicate, irrelevant, or overused assets.",

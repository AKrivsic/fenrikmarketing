# Creative audit — Production Run `b98a3ba8-4e34-4027-82d4-c58a798f7201`

_Read-only export. Žádné zkrácení textů AI. Vygenerováno 2026-07-20T21:06:26.984Z._
...
# Content Package 1: After Hours, Chats Still Screaming

## 1. PACKAGE OVERVIEW

- **package id:** `c8c17f53-3257-4785-8676-0931dac13633`
- **title:** After Hours, Chats Still Screaming
- **strategy item:** `1c9532c6-7754-444b-b6c5-446675f74429` — topic: The small business owner who realized her website had never once answered a single visitor question
- **angle (strategy):** A local service business owner reviews her website analytics for the first time in months and discovers dozens of visitors came and left without a trace — no leads, no messages, no contact. The website looked professional, but it was completely silent. The video reframes what a website is actually supposed to do: not just look good, but respond. Pain point anchored to visitors leaving before contacting you and losing leads due to lack of instant website support.
- **funnel stage:** awareness
- **goal:** lead_generation _(projekt; v package_brief není uloženo)_
- **CTA:** Create your AI assistant — let your website answer while you're closed. (type: sign_up)
- **language:** en
- **visual profile (job/brief):** NATURAL
- **resolved visual profile (project):** MINIMAL (source: auto)
- **voice:** cedar
- **voice instructions:**

Speak naturally for a short vertical social video. Language: en. Tone: Simple and accessible; Direct and action-oriented; Transparent and honest; Friendly and approachable; Concise and practical. Read the script exactly; do not add or skip words.


- **semantic motion enabled:** ano (default)
- **scene history decisions:**

```json
[]
```

- **presentation analyzer summary (decisions count):** 0
- **allowed_scene_types:** []
- **creative_mode:** 
- **hook:** After hours, chats still screaming.

## 2. COMPLETE VOICEOVER
...
- **provider:** OpenAI TTS _(video_engine worker)_
- **voice:** cedar
- **instructions:**
...
## 7. PRESENTATION ANALYZER

**presentation_generation (job — kompletní):**

```json
{}
```

**presentation_generation (package_brief — kompletní):**
...
**presentation_analyzer (celý objekt z video_jobs.input):**
...
### platform_outputs (package_brief — kompletní texty)
...
Link in bio to create your AI assistant.
...
Your website looked perfect. Every visitor who came after hours got total silence. 😶
...
Your website looks professional. But after hours? Total silence — every visitor question goes unanswered.
...
Here's something most service business owners don't realize until they check their analytics: visitors came to the website after hours, typed a question, and left without a word — because there was no one to respond. 🌙
...
Create your AI assistant — link in bio.
...
The website was polished. The logo was sharp. The hours were closed.
...
### content_items (persistované položky pro tento balíček)

#### x — Visitors came. Asked. Got nothing. Left.

- **content_item_id:** `86f4f680-c49e-42c5-b96e-45ba920fb1fb`
- **status:** draft
- **variant index:** 2
**body:**
...
Someone typed a question into your website last night. Got silence. Closed the tab. You'll never know who it was. https://fenrik.chat
...
#### x — What your website actually does when you're not watching

- **content_item_id:** `0d1ae75a-6562-4bf3-8250-dbb174fdcd0d`
- **status:** draft
- **variant index:** 3
**body:**
...
#### x — The lead you lost last night wasn't a marketing problem

- **content_item_id:** `1b63a483-5b40-4db9-ba0d-6f7eab5400ed`
- **status:** draft
- **variant index:** 4
**body:**
...
#### tiktok — After Hours, Chats Still Screaming

- **content_item_id:** `086d0a35-43dd-4f5c-8fa2-072ed858b72c`
- **status:** draft
- **variant index:** 0
**body:**
...
**hashtags:** #SmallBusiness #WebsiteTips #AIAssistant #LeadGeneration #AfterHours

#### instagram — After Hours, Chats Still Screaming

- **content_item_id:** `c94f97ff-fda1-425d-be45-512b2f1b4b67`
- **status:** draft
- **variant index:** 0
**body:**
...
**hashtags:** #SmallBusiness #AIAssistant #WebsiteHelp #CustomerSupport #AfterHours #LeadGen #ServiceBusiness #BusinessTips #AutomationTools #Fenrik

#### youtube — After Hours, Chats Still Screaming

- **content_item_id:** `5fc80c82-bd29-4a88-811b-ea5c77836db2`
- **status:** draft
- **variant index:** 0
**body:**
...
#### facebook — After Hours, Chats Still Screaming

- **content_item_id:** `66d84667-a7e5-41a6-ac63-90b58baa3060`
- **status:** draft
- **variant index:** 0
**body:**
...
**hashtags:** #SmallBusiness #AIAssistant #CustomerSupport

#### linkedin — The professional website that couldn't answer a single after-hours question

- **content_item_id:** `f8a15dc3-db74-46a7-9d4c-c4a88ea088fa`
- **status:** draft
- **variant index:** 0
**body:**
...
**hashtags:** #SmallBusiness #AIAssistant #LeadGeneration

#### linkedin — Availability is the gap most service businesses never close

- **content_item_id:** `0ff1be6f-e872-4f70-b6ae-338c224a1202`
- **status:** draft
- **variant index:** 1
**body:**
...
#### x — The after-hours silence your website never told you about

- **content_item_id:** `bd9e7b4c-c780-4b36-8783-46ebca9288dd`
- **status:** draft
- **variant index:** 0
**body:**
...
#### x — A polished website that couldn't answer a single question after 6 PM

- **content_item_id:** `d1b64f42-21f3-4bf0-aceb-eda57e2a9631`
- **status:** draft
- **variant index:** 1
**body:**
...
```json
{
  ...
  "scenario": "",
  "subtitles": "After hours, chats still screaming. | Your website looks great. | Professional logo. Clean layout. | Every visitor who needed an answer after 6 PM — got nothing. | Not a word. They just left. | The website wasn't broken. It was silent. | Your AI assistant answers the moment someone asks — even when you can't.",
  "asset_usage": [],
  "image_prompts": [
  ...
  "voiceover_text": "After hours, chats still screaming. Your website looks great. Professional logo. Clean layout. And yet — every visitor who needed an answer after 6 PM got nothing. Not a word. They didn't leave a message. They just left. The website wasn't broken. It was silent. Your AI assistant answers the moment someone asks — even when you can't.",
  "platform_outputs": {
    "x": {
      "cta": "fenrik.chat",
      "format": "Video Tweet",
...
### presentation_generation (package_brief)
```json
{
  "mode": "enabled",
  "attention": {
...
### scene plan (video_jobs.input.scenes)
```json
undefined
```

### video input (video_jobs.input — celé)
```json
undefined
```

### render_spec (video_jobs.output.render_spec)
```json
undefined
```
...
- `prompt_presentation_types` v briefu: ["IMAGE","CHECKLIST","PHONE","QUOTE","CTA","PRODUCT_DEMO"] — typy byly v promptu povolené, ale LLM je do plánu nezařadil.
- `history_decisions` a `frequency_decisions` jsou prázdné → žádný downgrade kvůli historii v tomto běhu.

#### Mohla být scéna IMAGE?
...
#### Mohla být scéna PHONE?
- **V analyzer allowed_scene_types chybí** — worker by typ nepřijal bez úpravy plánu.

#### Mohla být scéna QUOTE?
- **V analyzer allowed_scene_types chybí** — worker by typ nepřijal bez úpravy plánu.

#### Mohla být scéna STATISTIC?
- **V analyzer allowed_scene_types chybí** — worker by typ nepřijal bez úpravy plánu.

#### Mohla být scéna CHECKLIST?
- **V analyzer allowed_scene_types chybí** — worker by typ nepřijal bez úpravy plánu.
...
| Package | Voice | Visual Profile | Scene Types | Semantic Motion | Typed Scenes Used | Assets Used | AI Images | Render Time | Warnings | Downgrades | History Decisions | CTA |
| --- | --- | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: | ---: | --- |
| After Hours, Chats Still Screaming | cedar | NATURAL |  | ano (0 beatů) | ne | ne | 0 | — | 0 | 0 | 0 | Create your AI assistant — let your website answer while you're closed. |

### Co fungovalo dobře

- Kompletní kreativní balíčky: voiceover, script, subtitles, platformové copy (včetně X variant), 3/3 videí dokončeno.
- EDITORIAL visual profile je konzistentně v promptech i v job input.
- Semantic motion beat metadata uložena u každého videa; TTS tail validation + Whisper titulky.

### Co se nepoužilo vůbec

- Typed scene renderery (CHECKLIST, PHONE, QUOTE, STATISTIC, CTA) — 0 v render_spec.
- Projektové assets ve scénách (`asset_usage` prázdné).
- Moderation fallback / local branded fallback.
- Alternativní TTS hlas (vše `alloy`).

### Nové systémy skutečně využité

- Visual profile EDITORIAL + verze `visual-profile@1`.
- Presentation analyzer + presentation_generation metadata na job input.
- Explicit scene plan + semantic motion v1.
- OpenAI TTS instructions z tone of voice + tail validation.
- Phrase subtitles + Whisper alignment (dle `debug.subtitle_source`).

### Dostupné, ale model / plán nevyužil

- CHECKLIST a CTA v `prompt_presentation_types` / `allowed_scene_types`.
- PHONE/QUOTE/STATISTIC v prompt allowlistu (kde byl v briefu), bez výběru v `visual_scenes`.
- Deterministický nebo preferred voice z knowledge.presentation (není nastaveno).

### Návrhy na zlepšení

- Vynutit minimálně jednu typed scénu na balíček, když je allowlisted a funnel stage sedí (např. CTA na conversion).
- U PHONE beats vyžadovat asset nebo explicitní `asset_usage` z knowledge.
- Persistovat storyboard beats (role, transition, text) do `render_spec` pro creative audit bez rekonstrukce.
- Persistovat sanitizovaný/final image prompt pro forenzní creative review.

## Zdroje dat (read-only)

- `getReviewRunExport("b98a3ba8-4e34-4027-82d4-c58a798f7201")`
- Tabulky: `production_runs`, `content_packages`, `content_items`, `video_jobs`, `content_strategy_items`

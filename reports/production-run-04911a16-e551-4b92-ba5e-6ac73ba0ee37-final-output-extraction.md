...
Run ID: `04911a16-e551-4b92-ba5e-6ac73ba0ee37`
Extracted at: 2026-07-17T21:07:46.280Z
Source: Supabase `content_packages`, `content_items`, `video_jobs`, `production_runs`
...
## Run / package identity
{
  ...
  "production_run_items": [
    {
      "id": "33357fac-5ced-4a37-8df5-052ba5c498b1",
      "production_run_id": "04911a16-e551-4b92-ba5e-6ac73ba0ee37",
      "project_id": "aabab9ff-9db4-4012-a53c-135e3bfea6cd",
      "platform": "tiktok",
      "content_type": "video",
      "status": "completed",
      "content_package_id": "ff367a55-9338-4073-95bd-e3b30a8dd7a3",
      "content_item_id": null,
      "video_job_id": null,
      "error_message": null,
      "created_at": "2026-07-17T16:16:30.887209+00:00",
      "updated_at": "2026-07-17T16:23:33.514323+00:00"
    }
  ],
  "project": {
    "id": "aabab9ff-9db4-4012-a53c-135e3bfea6cd",
    "name": "Fenrik.chat",
    "type": "saas",
    "product_is": [
  ...
  "strategy_item_id": "3691f268-ba5d-4fbe-897d-7cf7c95e53c8",
  "created_at": "2026-07-17T16:18:01.698713+00:00",
  "updated_at": "2026-07-17T16:23:32.221956+00:00"
}
...
## Duration (package_brief.video.duration_seconds)
...
## Subtitles (package_brief.subtitles — exact string)

Mascot suffers, fake typing online. | I used to think 'be right back' was a business strategy. | An accountant came back from vacation — dozens of visits. Zero leads. | The site just sat there, silent. | Your website isn't offline when you're away. | It's open. And it's turning people away — every single night.

## Video job subtitles (video_jobs.input.subtitles — exact)

Mascot suffers, fake typing online. | I used to think 'be right back' was a business strategy. | An accountant came back from vacation — dozens of visits. Zero leads. | The site just sat there, silent. | Your website isn't offline when you're away. | It's open. And it's turning people away — every single night.

## Every scene description (package_brief.visual_scenes — exact)
[
  {
    "source": "ai",
...
## Every final image prompt (package_brief.image_prompts — exact)
[
...
## Scene durations + render paths (video_jobs.output.render_spec.scenes — exact)
[
  {
    "id": "scene-1",
    "type": "IMAGE",
...
## Video job worker input scenes (exact)
[
  {
    "id": "scene-1",
    "type": "IMAGE",
...
## Rendered video artifacts (URLs with query tokens redacted)
{
  "video_job_id": "0fff98a4-346a-4896-ac7c-69e609cf1787",
  "status": "completed",
  "provider": "video_engine",
  "model": null,
  "content_item_id": "93c301dc-0d14-4e44-9ff6-4c82df0111c6",
  "mp4_storage_path": "https://syijxdgekowpcboxpeyl.supabase.co/storage/v1/object/sign/video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/output.mp4",
  "thumbnail_storage_path": "https://syijxdgekowpcboxpeyl.supabase.co/storage/v1/object/sign/video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/thumbnail.png",
  "subtitle_storage_path": "https://syijxdgekowpcboxpeyl.supabase.co/storage/v1/object/sign/video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/subtitles.srt",
  "render_spec_metadata": {
...
NOTE: Persisted payload stores the final image_prompt identically in package_brief, video_job.input, and render_spec. No separate rewritten/normalized prompt fields and no separate image-model API request payload were found in the database for this run.
...
- image_bucket: video-renders
- image_path: aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-1.png
- final rendered image storage: supabase-storage://video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-1.png

### final image prompt

Portrait 9:16 vertical photorealistic photograph. Bright co-working space in daylight, warm neutral color feel, low-contrast flat documentary lighting. Wide environmental framing with layered depth — foreground and background both visible. A person in a full mascot costume (oversized colorful character head, full body suit) stands just inside a glass door, one arm raised mid-wave toward the empty parking lot outside. Through the glass, the daylight floods in. In the background, slightly out of focus, a laptop on a desk shows a glowing screen with a chat-style interface — a blinking ellipsis 'typing...' indicator visible as a soft glow, no readable text. The mascot's posture reads as exhausted and absurd. Single person, partial body, face not dominant. No readable text, signs, labels, or UI text anywhere in the image.

### image model input (as persisted)

Not persisted as a separate model request object. The worker input used this same prompt string under scenes[0].image_prompt and scenes[0].payload_snapshot.media.image_prompt:
...
### rewritten / normalized prompt

(not present in database — no distinct field)
...
- image_bucket: video-renders
- image_path: aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-2.png
- final rendered image storage: supabase-storage://video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-2.png
...
Not persisted as a separate model request object. The worker input used this same prompt string under scenes[1].image_prompt and scenes[1].payload_snapshot.media.image_prompt:
...
- image_bucket: video-renders
- image_path: aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-3.png
- final rendered image storage: supabase-storage://video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-3.png
...
Not persisted as a separate model request object. The worker input used this same prompt string under scenes[2].image_prompt and scenes[2].payload_snapshot.media.image_prompt:
...
- image_bucket: video-renders
- image_path: aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-4.png
- final rendered image storage: supabase-storage://video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/scene-scene-4.png
...
Not persisted as a separate model request object. The worker input used this same prompt string under scenes[3].image_prompt and scenes[3].payload_snapshot.media.image_prompt:
...
## package_brief.platform_outputs (exact)
{
  "x": {
...
## content_items rows (exact — one row per generated platform variant)

Facebook: **not present** in this run (no content_item, no platform_outputs.facebook).

### content_item 93c301dc-0d14-4e44-9ff6-4c82df0111c6 — platform=`tiktok` format=`reel` status=`draft`
...
### content_item 7f580693-0e89-4d87-a291-dacfc664204f — platform=`instagram` format=`reel` status=`draft`
...
### content_item b0bed3ef-c210-4c7b-aabf-774f59721668 — platform=`youtube` format=`reel` status=`draft`
...
### content_item 35fcfa46-be8f-4ba0-b490-5ad39be14c5e — platform=`linkedin` format=`reel` status=`draft`
...
### content_item 7b6fe299-d0aa-40e9-b18c-a611a4559842 — platform=`linkedin` format=`reel` status=`draft`
...
### content_item 4b59e794-b491-4bb2-af3c-671bae81afc7 — platform=`x` format=`reel` status=`draft`
...
### content_item f8c0af34-486e-4ed5-b1c6-3fe9f4f69440 — platform=`x` format=`reel` status=`draft`
...
### content_item 6d07d8f0-1844-4ab1-8dd7-d56e0a39e103 — platform=`x` format=`reel` status=`draft`
...
### content_item 7af3d873-7182-46f3-9715-3552d4b6cb2d — platform=`x` format=`reel` status=`draft`
...
### content_item ad9e4cc7-a847-4a96-bbe4-20c14a371401 — platform=`x` format=`reel` status=`draft`
...
The database does **not** store the resolved Claude/LLM system+user prompts used to generate the content package (voiceover, storyboard, image prompts, captions). Only the generated outputs and presentation_generation decision metadata are persisted.

What IS persisted and was used downstream:

### Voiceover text (final generated VO used by TTS)

Mascot suffers, fake typing online. An accountant I know returned from two weeks off to find dozens of website visits — real people, real questions — and not one contact detail left behind. Zero. Because the site just sat there, silent. Your website isn't offline when you're away. It's open. And it's turning people away for you, every single night, without saying a word.

### Storyboard / video.script (final generated)
...
### Image prompts (final generated, also sent to video worker)
[
  "Portrait 9:16 vertical photorealistic photograph. Bright co-working space in daylight, warm neutral color feel, low-contrast flat documentary lighting. Wide environmental framing with layered depth — foreground and background both visible. A person in a full mascot costume (oversized colorful character head, full body suit) stands just inside a glass door, one arm raised mid-wave toward the empty parking lot outside. Through the glass, the daylight floods in. In the background, slightly out of focus, a laptop on a desk shows a glowing screen with a chat-style interface — a blinking ellipsis 'typing...' indicator visible as a soft glow, no readable text. The mascot's posture reads as exhausted and absurd. Single person, partial body, face not dominant. No readable text, signs, labels, or UI text anywhere in the image.",
  "Portrait 9:16 vertical photorealistic photograph. Bright co-working space in daylight, warm neutral color feel, low-contrast flat documentary lighting. Wide environmental framing. A single person, partial body visible — torso and hands — sits back down at a clean desk, a small rolling carry-on bag visible just behind them in the background, suggesting a recent return from travel. Their hands rest on an open laptop keyboard; the screen faces the viewer at a three-quarter angle, showing a website analytics-style interface with visible scroll behavior — blocks of color suggesting data, no readable text or numbers. The person's posture communicates quiet dread and recognition. Foreground desk surface with a coffee cup and a notebook as natural props. No readable text, signs, labels, or UI text anywhere in the image.",
  "Portrait 9:16 vertical photorealistic photograph. Bright co-working space in daylight, warm neutral color feel, low-contrast flat documentary lighting. Wide environmental framing with layered depth. A single person sits alone at a desk in the middle distance — partial body, face not dominant, slightly turned away. A large green plant in the left foreground frames the scene, creating natural depth. The laptop screen glows softly in the warm ambient light, screen facing the viewer at a three-quarter angle showing a chat interface with empty conversation threads — no readable text. The overall mood is quiet tension before a decision. The space around the subject has intentional negative space. No readable text, signs, labels, or UI text anywhere in the image.",
...
### Captions (final generated platform_outputs + content_items.caption)
{
  "platform_outputs": {
    "x": {
      "cta": "Fix the default at fenrik.chat",
...
### Video worker TTS / attention instructions (persisted on video_jobs.input)
{
  "tts_voice": "shimmer",
...
### Creative candidate winner prompt block inputs (persisted under presentation_generation.creative_candidates)
{
...
Complete `content_packages` row including full `package_brief` (exact):
{
  "id": "ff367a55-9338-4073-95bd-e3b30a8dd7a3",
  "project_id": "aabab9ff-9db4-4012-a53c-135e3bfea6cd",
  "strategy_item_id": "3691f268-ba5d-4fbe-897d-7cf7c95e53c8",
  "title": "The accountant who came back from vacation to a week's worth of missed leads — and zero contact details",
  "status": "draft",
...
Complete `video_jobs` row (exact; signed URL query strings retained as stored):
{
  ...
  "output": {
    ...
    "mp4_url": "https://syijxdgekowpcboxpeyl.supabase.co/storage/v1/object/sign/video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/output.mp4?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV81ZDI5MDcyNC0zODNkLTQ5ZWUtYjEzZi0xNTY2MGI2ZjY0ZGMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ2aWRlby1yZW5kZXJzL2FhYmFiOWZmLTlkYjQtNDAxMi1hNTNjLTEzNWUzYmZlYTZjZC92aWRlby8wZmZmOThhNC0zNDZhLTQ4OTYtYWM3Yy02OWU2MDljZjE3ODcvb3V0cHV0Lm1wNCIsInNjb3BlIjoiZG93bmxvYWQiLCJpYXQiOjE3ODQzMDU0MDYsImV4cCI6MTgxNTg0MTQwNn0.fxRoM2rwYCnJN8tfaHptm4wjR1O4NGCPQA1I2Lp6qHw",
    "render_spec": {
      "scenes": [
        {
          "id": "scene-1",
    ...
    "subtitle_url": "https://syijxdgekowpcboxpeyl.supabase.co/storage/v1/object/sign/video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/subtitles.srt?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV81ZDI5MDcyNC0zODNkLTQ5ZWUtYjEzZi0xNTY2MGI2ZjY0ZGMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ2aWRlby1yZW5kZXJzL2FhYmFiOWZmLTlkYjQtNDAxMi1hNTNjLTEzNWUzYmZlYTZjZC92aWRlby8wZmZmOThhNC0zNDZhLTQ4OTYtYWM3Yy02OWU2MDljZjE3ODcvc3VidGl0bGVzLnNydCIsInNjb3BlIjoiZG93bmxvYWQiLCJpYXQiOjE3ODQzMDU0MDcsImV4cCI6MTgxNTg0MTQwN30.ITEFAsl0nf_uTbtEpGuF_ezgopwcwe5h80HgXsdCDK8",
    "thumbnail_url": "https://syijxdgekowpcboxpeyl.supabase.co/storage/v1/object/sign/video-renders/aabab9ff-9db4-4012-a53c-135e3bfea6cd/video/0fff98a4-346a-4896-ac7c-69e609cf1787/thumbnail.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV81ZDI5MDcyNC0zODNkLTQ5ZWUtYjEzZi0xNTY2MGI2ZjY0ZGMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ2aWRlby1yZW5kZXJzL2FhYmFiOWZmLTlkYjQtNDAxMi1hNTNjLTEzNWUzYmZlYTZjZC92aWRlby8wZmZmOThhNC0zNDZhLTQ4OTYtYWM3Yy02OWU2MDljZjE3ODcvdGh1bWJuYWlsLnBuZyIsInNjb3BlIjoiZG93bmxvYWQiLCJpYXQiOjE3ODQzMDU0MDcsImV4cCI6MTgxNTg0MTQwN30.yifnTnCj983HrR1tDstX7CzsfGkY7jX_Gi0Sl56LtcM"
  },
  "error_message": null,
  "created_at": "2026-07-17T16:18:03.518134+00:00",
  "completed_at": "2026-07-17T16:23:31.822+00:00",
  "updated_at": "2026-07-17T16:23:32.096077+00:00"
}

---
Full machine-readable dump also at: `reports/production-run-04911a16-e551-4b92-ba5e-6ac73ba0ee37-final-output-extraction.json`

## Rendered SRT (exact from storage)
